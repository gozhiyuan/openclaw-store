...
```text
Start the Autonomous Project Management with Subagents demo project from the malaclaw starter `autonomous-project-management`. Managing complex projects with multiple parallel workstreams is exhausting. You end up context-switching constantly, tracking status across tools, and manually coordinating handoffs. Use `dev-company` as the initial entry team. Review STARTER.md, confirm any missing external integrations, then break the work into clear team tasks.
```

## Suggested Flow

1. Inspect the starter with `malaclaw starter show autonomous-project-management`.
2. Initialize it with `malaclaw starter init autonomous-project-management <dir>`.
